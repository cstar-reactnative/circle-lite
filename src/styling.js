...
const bottomCardLogin = { elevation: 4, width: deviceWidth - 40, height: 230, padding: 20, borderRadius: 24, backgroundColor: 'white' }
...
const detailsBottomCard = { elevation: 4, width: deviceWidth - 40, padding: 20, borderRadius: 24, backgroundColor: 'white' }
const qrCodeDiv = { justifyContent: 'center', alignItems: 'center', elevation: 4, width: deviceWidth - 40, marginTop: 20, height: 300, padding: 20, borderRadius: 24, backgroundColor: 'white' }
